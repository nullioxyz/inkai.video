# AI Application - Next.js SaaS Template
...
```
ai-application-ns-next/
├── public/                     # Static assets
│   ├── images/                 # Images (347 files: PNG, SVG, JPG)
...
| FAQ Data        | `src/data/json/faq.json`          | -     |
| Changelog       | `src/data/json/changelog.json`    | -     |
| Glossary        | `src/data/json/glossary.json`     | -     |
| Testimonials    | `src/data/json/testimonials.json` | -     |
